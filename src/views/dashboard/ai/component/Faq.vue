<template>
  <div class="card px-20 py-20 radius-20">
    <div class="card__header mb-3">
      <h4 class="title">All FAQ</h4>
      <div class="btn__group">
        <router-link :to="{ name: 'train-ai-agent-add-faq' }" class="sg-btn sg-btn-dark"
          >Add FAQ</router-link
        >
      </div>
    </div>
    <div class="card__body">
      ...
      <div class="file__item" v-for="items in paginatedFaqData" :key="items.id">
        ...
        <div class="action__btn">
          <router-link :to="{ name: 'train-ai-agent-view-faq' }" class="button">
            <HugeiconsIcon :icon="ViewIcon" />
          </router-link>
          <router-link :to="{ name: 'train-ai-agent-edit-faq' }" class="button">
